...
#*****************************************************************
save_path_and_model_name = "Two_stream_InceptionResNetV2_FE_batch64_dropout03"
batch_size = 64
num_epochs = 25
threshold = 999
dropout = 0.3
...
######################################################################
features0_dim = model_conv0.classif.in_features
features1_dim = model_conv1.classif.in_features
