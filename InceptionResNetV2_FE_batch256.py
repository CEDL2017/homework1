...
#*****************************************************************
save_path_and_model_name = "InceptionResNetV2_FE_batch256"
batch_size = 256
num_epochs = 25
threshold = 999
...
model_conv0.classif = nn.Linear(1536, 24)
...
model_conv1.classif = nn.Linear(1536, 24)
...
# opoosed to before.
optimizer_conv0 = optim.Adam(model_conv0.classif.parameters(), lr=0.001)
optimizer_conv1 = optim.Adam(model_conv1.classif.parameters(), lr=0.001)
