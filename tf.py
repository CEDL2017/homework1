...
from test_load_datas import *

parser = argparse.ArgumentParser()
parser.add_argument('--train_dir', default='coco-animals/train')
parser.add_argument('--val_dir', default='coco-animals/val')
parser.add_argument('--model_path', default='/home/yoooosing/Caroline/code/vgg_16.ckpt', type=str)
...
def main(args):
    ...
    train_labels = duplicate_train_labels
    ...
    #val_filenames = test_images
    #val_labels = duplicate_test_labels
