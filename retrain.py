...
train_layers = ['fc8', 'fc7', 'fc6', 'conv5_3_head', 'conv4_3_head', 'conv3_3_head', 'conv5_3_hand', 'conv4_3_hand', 'conv3_3_hand']
...
with tf.Session() as sess:
    ...
    saver.restore(sess, './checkpoints/retrain_model_epoch11.ckpt')
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        checkpoint_name = os.path.join(checkpoint_path, 'retrain_model_epoch'+str(epoch+1)+'.ckpt')
