...
obj_index_2_name = {index: name for name, index in obj_name_2_index.items()}
...
#                 grid_p1 = (int(j * grid_width), int(i * grid_height))
#                 grid_p2 = (int(j * grid_width + grid_width), int(i * grid_height + grid_height))
#                 line2_p = (int(j * grid_width), int(i * grid_height + 30))

#                 # Draw the information
#                 _class = np.argmax(scores, axis=0)[i][j]
#                 cv2.rectangle(res, grid_p1, grid_p2, 
#                     obj_index_2_response_color_tuple[_class], thickness=5)
#                 cv2.putText(res, obj_index_2_name[_class], line2_p, cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 255),thickness=3)
#                 # cv2.putText(res, str(round(scores[_class][i][j], 2)), line2_p, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255))
#     return res
