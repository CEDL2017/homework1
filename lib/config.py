...
# Model constants
# model_path = '../model/150x150(0.402).h5'
model_path = '../model/scorenet.h5'
...
train_img_path = '/media/timyang/My Passport/frames/train/house/1/Lhand/'
scorenet_img_path = '/media/timyang/My Passport/frames/train/house/1/Lhand/'
scorenet_dat_path = '../dat/'
