...
### Results
1. In the project, I experiment different random croped size on images for evaluate the effect of data augmentation. The following images are the example that hand and head images random croped to 299 x 299 (resize the short side to 312 then crop to (299, 299)).
