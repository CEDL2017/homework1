...
#_NUM_VALIDATION = 1400 # train
_NUM_VALIDATION = 0 # test
...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  CEDLhw1_root = os.path.join(dataset_dir, 'photos')
  directories = []
  class_names = []
  for filename in os.listdir(CEDLhw1_root):
    path = os.path.join(CEDLhw1_root, filename)
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'CEDLhw1_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
  ...
  print('\nFinished converting the CEDLhw1 dataset!')
