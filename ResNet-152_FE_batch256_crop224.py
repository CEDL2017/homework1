...
#*****************************************************************
save_path_and_model_name = "ResNet-152_FE_batch256_crop224"
batch_size = 256
num_epochs = 25
threshold = 999
...
transform_train = transforms.Compose([
        transforms.Scale(224), transforms.RandomCrop((224, 398)),
        transforms.ToTensor(),
        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
    ])

transform_test = transforms.Compose([
        transforms.Scale(224), transforms.CenterCrop((224, 398)),
        transforms.ToTensor(),
        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
    ])
################################################################################################
