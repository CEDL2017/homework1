...
_FILE_PATTERN = 'handcam_%s_*.tfrecord'
...
_ITEMS_TO_DESCRIPTIONS = {
    ...
    'label1': 'The label1 id of the image, integer between 0 and 999',
    'label2': 'The label2 id of the image, integer between 0 and 999',
    'label_text': 'The text of the label.',
    'object/bbox': 'A list of bounding boxes.',
    'object/label': 'A list of labels, one per each object.',
}

_NUM_CLASSES = np.array([2, 13, 24])
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  keys_to_features = {
      ...
      'image/class/label1': tf.FixedLenFeature(
          [], dtype=tf.int64, default_value=-1),
      'image/class/label2': tf.FixedLenFeature(
          [], dtype=tf.int64, default_value=-1),
  ...
  items_to_handlers = {
      ...
      'label1': slim.tfexample_decoder.Tensor('image/class/label1'),
      'label2': slim.tfexample_decoder.Tensor('image/class/label2'),
  ...
  labels_to_names = []
  for cl in xrange(3):
    labels_to_names.append(dataset_utils.read_label_file(dataset_dir, filename=cls[cl]+'lbl.txt'))
